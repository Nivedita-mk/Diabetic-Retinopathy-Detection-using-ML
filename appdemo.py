...
class_names_display = ' | '.join([f"{40}-{class_name}" for class_name in ['Healthy', 'Mild DR', 'Moderate DR', 'Proliferative DR', 'Severe DR']])
st.write("Model has been trained with: ", class_names_display)
